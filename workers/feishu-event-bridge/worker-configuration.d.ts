/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/feishu-event-bridge/wrangler.jsonc workers/feishu-event-bridge/worker-configuration.d.ts` (hash: 28c35c6b8fc8d8c8475cec460cd3fb2f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAXOPS_ALLOW_HTTP_FALLBACK">> {}
}
